...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      alex_app_email: email,
      alex_app_company_email: email,
      alex_app_timezone: timezone,
      alex_app_country: country,
      alex_app_language: language || 'ru_ru',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully alex App Setup',
  });
};
